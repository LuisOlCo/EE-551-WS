...
print('The lag between the GDP growth and the renewable energy growth is: ')
print(str(lag)+' years')
...
print("GDP growth vector: ")
print(tasa_GDP)
print("Renewable energy growth vector: ")
...
n = 2-lag-1
print('The renewable energy growth on 2019 depends on the GDP growth of '+str(2019-lag))
delta_GDP= GDP_year_country[n] - GDP_year_country[n-1]
delta_RE_production = delta_GDP*m + c
print('The renewable energy production growth expected in 2019 in '+ country_study+ ' is '+str(round(delta_RE_production,2))+'%')
